...
"[project]/frontend/components/dashboard/UserGreeting.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserGreeting() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserGreeting.useEffect": ()=>{
            const parsedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$currentUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStoredUser"])();
            if (!parsedUser?.id) {
                return;
            }
            const closeStream = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["streamUser"])({
                id: parsedUser.id,
                onMessage: {
                    "UserGreeting.useEffect.closeStream": (nextUser)=>{
                        setUser(nextUser);
                    }
                }["UserGreeting.useEffect.closeStream"]
            });
            return ({
                "UserGreeting.useEffect": ()=>{
                    closeStream();
...
_s(UserGreeting, "5s2qRsV95gTJBmaaTh11GoxYeGE=");
_c = UserGreeting;
var _c;
...
"[project]/frontend/components/dashboard/NotesBoard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotesBoard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotesBoard.useEffect": ()=>{
            const storedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$currentUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStoredUser"])();
            if (!storedUser?.id) {
                return;
            }
            ...
            async function loadInitialNotes() {
                try {
                    const initialNotes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNotes"])(storedUser.id);
            ...
            loadInitialNotes();
            const closeStream = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["streamNotes"])({
                userId: storedUser.id,
                onMessage: {
                    "NotesBoard.useEffect.closeStream": (nextNotes)=>{
                        setNotes(nextNotes);
                        setError("");
                    }
                }["NotesBoard.useEffect.closeStream"],
                onError: {
                    "NotesBoard.useEffect.closeStream": ()=>{}
                }["NotesBoard.useEffect.closeStream"]
            });
    ...
    async function handleSubmit(event) {
        ...
        try {
            setLoading(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNote"])(userId, {
                title: title.trim(),
    ...
    async function handleDelete(noteId) {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteNote"])(userId, noteId);
        } catch (deleteError) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: notes.length ? notes.map((note)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
...
_s(NotesBoard, "/N6QyCRK6p+zts4cMx3R4SrRKSk=");
_c = NotesBoard;
var _c;
__turbopack_context__.k.register(_c, "NotesBoard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/components/dashboard/FocusTimer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FocusTimer() {
    _s();
    const [minutesInput, setMinutesInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("25:00");
    const [durationSeconds, setDurationSeconds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(25 * 60);
    const [remainingSeconds, setRemainingSeconds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(25 * 60);
    const [isRunning, setIsRunning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FocusTimer.useEffect": ()=>{
            ...
            const timer = window.setTimeout({
                "FocusTimer.useEffect.timer": ()=>{
                    setRemainingSeconds({
                        "FocusTimer.useEffect.timer": (previous)=>Math.max(previous - 1, 0)
                    }["FocusTimer.useEffect.timer"]);
                }
            }["FocusTimer.useEffect.timer"], 1000);
            return ({
                "FocusTimer.useEffect": ()=>window.clearTimeout(timer)
            })["FocusTimer.useEffect"];
        }
    }["FocusTimer.useEffect"], [
        isRunning,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: isRunning ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                    xmlns: "http://www.w3.org/2000/svg",
                                    width: "16",
                                    height: "16",
                                    fill: "currentColor",
...
_s(FocusTimer, "ULlseX3MTde9z84By+8RzBCH5Z8=");
_c = FocusTimer;
var _c;
...
"[project]/frontend/components/dashboard/AccountMenu.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AccountMenu() {
    ...
    const [openSettings, setOpenSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [steamActive, setSteamActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [malActive, setMalActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const settingsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const portalContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccountMenu.useEffect": ()=>{
            ...
            const closeStream = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["streamUser"])({
                id: storedUser.id,
                onMessage: {
                    "AccountMenu.useEffect.closeStream": (nextUser)=>{
                        setUser(nextUser);
                    }
                }["AccountMenu.useEffect.closeStream"],
                onError: {
                    "AccountMenu.useEffect.closeStream": ()=>{}
                }["AccountMenu.useEffect.closeStream"]
            });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccountMenu.useEffect": ()=>{
            const handleClickOutside = {
                "AccountMenu.useEffect.handleClickOutside": (event)=>{
            ...
            }["AccountMenu.useEffect.handleClickOutside"];
...
_s(AccountMenu, "NtW7rAnaomXlxFyWGSYT3Mw+Uyg=");
_c = AccountMenu;
var _c;
...
//# sourceMappingURL=frontend_93d1576c._.js.map