          ...
          <div className="relative w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900/75 p-8 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-10">
            <div className="mb-8">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Access your personalized activity dashboard.
              </p>
            </div>

            <div className="space-y-4">
              <Link href="/login">
                <button className="w-full rounded-xl bg-blue-500 py-3 font-semibold hover:bg-blue-600 transition-colors">
                  Sign In
                </button>
              </Link>
              <Link href="/signup">
                <button className="w-full rounded-xl border border-slate-700 bg-slate-950 py-3 font-semibold text-white hover:bg-slate-800 transition-colors">
                  Sign Up
                </button>
              </Link>
            </div>
